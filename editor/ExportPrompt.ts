...
export class ExportPrompt implements Prompt {
	private readonly _fileName: HTMLInputElement = input({type: "text", style: "width: 100%; height: 20px", value: " ", maxlength: 250, "autofocus": "autofocus"});
	...
	public readonly container: HTMLDivElement = div({class: "prompt noSelection", style: "width: 200px;"},
		...
		div({style: "display: table; width: 100%;"},
			div({style: "display: table-row;"},
				...
				div({style: "display: table-cell;"}, "Loops"),
		...
		div({style: "text-align: center;"}, "File Type"),
		div({class: "selectContainer", style: "width: 100%;"}, this._formatSelect),
		div({style: "display: center; justify-content: fill;"},
			this._exportButton,
		),
		this._cancelButton,
	);
