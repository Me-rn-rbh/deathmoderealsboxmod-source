...
export class ExportPrompt implements Prompt {
    ...
    private readonly _fileName: HTMLInputElement = input({ type: "text", style: "width: 100%; height: 10em;", value: " ", maxlength: 250, "autofocus": "autofocus" });
    ...
    private readonly _loopDropDown: HTMLInputElement = input({ style: "width: 2em;", type: "number", min: "1", max: "10", step: "1" });
    ...
    private readonly _exportButton: HTMLButtonElement = button({ class: "exportButton", style: "width:65%;" }, "Export");
    private readonly _outputProgressBar: HTMLDivElement = div({ style: `width: 0%; background: ${ColorConfig.loopAccent}; height: 100%; position: absolute; z-index: 1;` });
    private readonly _outputProgressLabel: HTMLDivElement = div({ style: `position: relative; top: -1px; z-index: 3;` }, "0%");
    private readonly _outputProgressContainer: HTMLDivElement = div({ style: `height: 12px; background: ${ColorConfig.uiWidgetBackground}; display: block; position: relative; z-index: 2;` },
    ...
    public readonly container: HTMLDivElement = div({ class: "prompt noSelection", style: "width: 200px;" },
        h2("Export"),
        div({ style: "text-align: center;" }, "File Name"),
        div({ style: "text-align: center;" }, this._fileName),
