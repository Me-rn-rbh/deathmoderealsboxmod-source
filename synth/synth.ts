...
export class Song {
	private static readonly _format: string = "D's Quick Box Mod";
	private static readonly _oldestVersion: number = 0;
	private static readonly _latestVersion: number = 45;
